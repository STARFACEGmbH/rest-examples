...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StarfaceRestApi.ConferenceConfigurationTexts();
  });
  ...
  describe('ConferenceConfigurationTexts', function() {
    it('should create an instance of ConferenceConfigurationTexts', function() {
      // uncomment below and update the code to test ConferenceConfigurationTexts
      //var instance = new StarfaceRestApi.ConferenceConfigurationTexts();
      //expect(instance).to.be.a(StarfaceRestApi.ConferenceConfigurationTexts);
    });
